...
<body>
     <%
        ...
        <%
                ...
                MExpediente expediente = bd.buscarExpediente(Integer.parseInt(request.getParameter("id")));
                ArrayList<MEscala> escalas = bd.buscarEscalas(Integer.parseInt(request.getParameter("id")));
    ...
    <section class="tabla-escala">
        ...
        <%
                ...
                ArrayList<MComentario> comentarios = bd.buscarComentario(Integer.parseInt(request.getParameter("id")));
        ...
        <div class="warp">
            ...
            <input type="hidden" value="<%=Integer.parseInt(request.getParameter("id"))%>" name="id_expediente">
            <a href="Expedientes.jsp" class="saber-mas">Regresa</a>
        </form>
        </div>
