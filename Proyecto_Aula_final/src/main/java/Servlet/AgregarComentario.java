...
public class AgregarComentario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        comentario.setId_expediente(Integer.parseInt(request.getParameter("id_expediente")));;
        BaseDeDatos bd = new BaseDeDatos();
        
        bd.insertarComentario(comentario);
        
        response.sendRedirect("Comentario.jsp?id="+Integer.parseInt(request.getParameter("id_expediente")));
    }
