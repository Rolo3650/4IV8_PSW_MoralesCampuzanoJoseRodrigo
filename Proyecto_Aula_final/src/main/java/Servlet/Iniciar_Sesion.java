...
public class Iniciar_Sesion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        MPersona persona = bd.buscarPersona(request.getParameter("correo"), request.getParameter("contra"));
        
        if (persona.getTipo_usuario()==1){
        ...
        } else if (persona.getTipo_usuario()==2){
