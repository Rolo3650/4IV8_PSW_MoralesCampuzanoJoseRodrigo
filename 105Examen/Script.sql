...
CREATE TABLE `cconfiguracion` (
  ...
  KEY `fk_CConfirguracion_CMarca1_idx` (`id_marca`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cconfiguracion`
--

LOCK TABLES `cconfiguracion` WRITE;
/*!40000 ALTER TABLE `cconfiguracion` DISABLE KEYS */;
/*!40000 ALTER TABLE `cconfiguracion` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `csexo` VALUES (1,'M'),(2,'F');
...
CREATE TABLE `mequipo` (
  ...
  `serial_cpu` int NOT NULL,
  `serial_monitor` int NOT NULL,
  `id_accesorios` int NOT NULL,
  `id_Lab` int NOT NULL,
  `id_config` int NOT NULL,
  PRIMARY KEY (`id_equipo`,`serial_cpu`,`serial_monitor`,`id_accesorios`,`id_Lab`,`id_config`),
  KEY `fk_MEquipo_MMonitor1_idx` (`serial_monitor`),
  KEY `fk_MEquipo_MAccesorios1_idx` (`id_accesorios`),
  KEY `fk_MEquipo_CLab1_idx` (`id_Lab`),
  KEY `fk_MEquipo_CConfiguracion1_idx` (`id_config`),
  KEY `fk_MEquipo_MCPU1` (`serial_cpu`),
  CONSTRAINT `fk_MEquipo_CConfiguracion1` FOREIGN KEY (`id_config`) REFERENCES `cconfiguracion` (`id_config`),
  ...
  CONSTRAINT `fk_MEquipo_MCPU1` FOREIGN KEY (`serial_cpu`) REFERENCES `mcpu` (`serial_cpu`),
  CONSTRAINT `fk_MEquipo_MMonitor1` FOREIGN KEY (`serial_monitor`) REFERENCES `mmonitor` (`serial_monitor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mimg` VALUES (1,'Img_alumno/img1.png');
...
-- Dump completed on 2022-04-18 20:08:56
